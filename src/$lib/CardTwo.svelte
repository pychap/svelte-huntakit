...
<div class="col-start-3 col-end-4 row-start-2 row-end-3 overflow-hidden bg-white rounded shadow-md text-slate-500 shadow-slate-200">
  <!-- Image -->
  <figure>
    <img src="https://picsum.photos/id/114/800/600" alt="card visual" class="aspect-video" />
  </figure>
  <!-- Body-->
  <div class="p-6">
